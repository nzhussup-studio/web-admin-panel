...
/* tslint:disable */
/* eslint-disable */
import type { base_service_WorkExperience } from '@/gen/api/models/base_service_WorkExperience';
...
export class WorkExperienceControllerService {
     ...
     * @throws ApiError
     */
    public static listWorkExperience(): CancelablePromise<Array<Record<string, any>>> {
